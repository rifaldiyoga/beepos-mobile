...
@Database(entities = [
    ...
    PrinterKitchenEntity::class, PrinterKitchenDEntity::class, BpAccEntity::class,
    ...
    SaleAddOnDEntity::class, ItemDummyEntity::class, UnitDummyEntity::class, SrepEntity::class, BrandEntity::class], version = 1, exportSchema = false)
...
abstract class DbHelper : RoomDatabase() {
    ...
    abstract val srepDao : SrepDao

    abstract val brandDao: BrandDao

    abstract val bpAccDao: BpAccDao
