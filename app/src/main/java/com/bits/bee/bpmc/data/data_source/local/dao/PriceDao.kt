...
interface PriceDao : BaseDao<PriceEntity> {
    ...
    @Query("SELECT * FROM price WHERE pricelvl_id = :priceLvlId AND itemid = :itemId AND crc_id = :crcId")
    fun getPriceByPriceLvlItem(priceLvlId : Int, itemId : Int, crcId : Int) : PriceEntity?
