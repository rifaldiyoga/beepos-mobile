...
public class PilihPidFragmentDirections private constructor() {
  private data class ActionPilihPidFragmentToEditItemDialog(
    public val saled: Saled? = null,
    public val item: Item? = null,
    public val pid: Stock? = null
  ) : NavDirections {
    public override val actionId: Int = R.id.action_pilihPidFragment_to_editItemDialog
  ...
  public companion object {
    public fun actionPilihPidFragmentToEditItemDialog(
      saled: Saled? = null,
      item: Item? = null,
      pid: Stock? = null
    ): NavDirections = ActionPilihPidFragmentToEditItemDialog(saled, item, pid)
  }
}
