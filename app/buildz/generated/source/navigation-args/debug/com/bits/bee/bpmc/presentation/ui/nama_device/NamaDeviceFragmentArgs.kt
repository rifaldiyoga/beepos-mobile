...
public data class NamaDeviceFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): NamaDeviceFragmentArgs {
      bundle.setClassLoader(NamaDeviceFragmentArgs::class.java.classLoader)
      ...
      return NamaDeviceFragmentArgs(__username, __password)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): NamaDeviceFragmentArgs {
      val __username : String?
