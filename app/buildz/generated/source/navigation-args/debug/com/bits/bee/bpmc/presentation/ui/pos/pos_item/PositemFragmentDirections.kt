...
public class PositemFragmentDirections private constructor() {
  private data class ActionPositemFragmentToAddOnFragment(
    public val item: Item,
    public val bp: Bp,
    public val priceLvlId: Int = 1,
    public val saled: Saled? = null
  ) : NavDirections {
    public override val actionId: Int = R.id.action_positemFragment_to_addOnFragment
  ...
  public companion object {
    public fun actionPositemFragmentToAddOnFragment(
      item: Item,
      bp: Bp,
      priceLvlId: Int = 1,
      saled: Saled? = null
    ): NavDirections = ActionPositemFragmentToAddOnFragment(item, bp, priceLvlId, saled)
  }
}
