...
public final class ItemProdukDummyBinding implements ViewBinding {
  @NonNull
  ...
  private ItemProdukDummyBinding(@NonNull ConstraintLayout rootView, @NonNull CardView cardView,
      @NonNull CardView cdContent, @NonNull ImageView imageItem,
      @NonNull LinearLayout linearLayout3, @NonNull LinearLayout llMinus,
      @NonNull LinearLayout llQty, @NonNull TextView tvHarga, @NonNull TextView tvNamaItem,
      @NonNull TextView tvPid, @NonNull TextView tvQty) {
  ...
  @NonNull
  public static ItemProdukDummyBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemProdukDummyBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_produk_dummy, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemProdukDummyBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemProdukDummyBinding((ConstraintLayout) rootView, cardView, cdContent, imageItem,
          linearLayout3, llMinus, llQty, tvHarga, tvNamaItem, tvPid, tvQty);
    }
