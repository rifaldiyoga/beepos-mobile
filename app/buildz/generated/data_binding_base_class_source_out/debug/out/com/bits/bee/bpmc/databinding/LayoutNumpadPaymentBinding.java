...
public final class LayoutNumpadPaymentBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final Button numpadBtn00;
  ...
  private LayoutNumpadPaymentBinding(@NonNull LinearLayout rootView, @NonNull Button numpadBtn0,
      @NonNull Button numpadBtn00, @NonNull Button numpadBtn1, @NonNull Button numpadBtn2,
      @NonNull Button numpadBtn3, @NonNull Button numpadBtn4, @NonNull Button numpadBtn5,
      @NonNull Button numpadBtn6, @NonNull Button numpadBtn7, @NonNull Button numpadBtn8,
      @NonNull Button numpadBtn9, @NonNull ImageButton numpadBtnDelete) {
    this.rootView = rootView;
    this.numpadBtn0 = numpadBtn0;
    this.numpadBtn00 = numpadBtn00;
  ...
  @NonNull
  public static LayoutNumpadPaymentBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutNumpadPaymentBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_numpad_payment, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutNumpadPaymentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.numpad_btn00;
      Button numpadBtn00 = ViewBindings.findChildViewById(rootView, id);
      if (numpadBtn00 == null) {
        break missingId;
      }
      ...
      return new LayoutNumpadPaymentBinding((LinearLayout) rootView, numpadBtn0, numpadBtn00,
          numpadBtn1, numpadBtn2, numpadBtn3, numpadBtn4, numpadBtn5, numpadBtn6, numpadBtn7,
          numpadBtn8, numpadBtn9, numpadBtnDelete);
    }
