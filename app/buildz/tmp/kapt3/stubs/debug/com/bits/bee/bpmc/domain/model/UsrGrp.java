...
public final class UsrGrp implements android.os.Parcelable {
    ...
    public static final android.os.Parcelable.Creator<com.bits.bee.bpmc.domain.model.UsrGrp> CREATOR = null;
    
    /**
     * Created by aldi on 17/03/22.
     */
    @org.jetbrains.annotations.NotNull()
    public final com.bits.bee.bpmc.domain.model.UsrGrp copy(int id, @org.jetbrains.annotations.NotNull()
    ...
    public UsrGrp(int id, @org.jetbrains.annotations.NotNull()
    java.lang.String usrCode, boolean disabled, int grpId, @org.jetbrains.annotations.NotNull()
    java.lang.String bpName, @org.jetbrains.annotations.NotNull()
    java.util.Date updatedAt) {
        super();
    ...
    public static final class Creator implements android.os.Parcelable.Creator<com.bits.bee.bpmc.domain.model.UsrGrp> {
        ...
        @org.jetbrains.annotations.NotNull()
        @java.lang.Override()
        public final com.bits.bee.bpmc.domain.model.UsrGrp createFromParcel(@org.jetbrains.annotations.NotNull()
        ...
        @org.jetbrains.annotations.NotNull()
        @java.lang.Override()
        public final com.bits.bee.bpmc.domain.model.UsrGrp[] newArray(int size) {
            return null;
        }
    }
}